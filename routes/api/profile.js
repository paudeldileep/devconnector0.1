...
router.get('/me',auth, async (req, res) =>{
    ...
    try{
        ...
        if(!profile){
            return res.status(400).json({msg:'Profile is Missing!'}); //no profile found for this user
        }
...
router.get('/user/:user_id',async (req, res) =>{
    ...
    try{
        ...
        if(!profile){
            return res.status(400).json({msg:'User Profile Not Found '}); //no profile found for this user
        }
